...
export const ROOMS = [
  ...
  room('OBSERVATION_DECK', {
    ...
    props: [
      ...
      { type: 'monitor', position: [-2.5, 0.9, 0], size: [0.6, 0.4, 0.05], color: 0x111122 },
      // Bench seating
  ...
  room('EXPERIMENT_LAB', {
    ...
    props: [
      ...
      // Central terminal
      { type: 'console', position: [0, 0, 0.5], size: [1.2, 0.9, 0.6], color: 0x333344 },
      { type: 'monitor', position: [0, 0.9, 0.5], size: [0.8, 0.5, 0.05], color: 0x111122 },
  ...
  room('DIRECTOR_SUITE', {
    ...
    props: [
      ...
      { type: 'document', position: [-2, 0.5, -2.5], size: [0.3, 0.02, 0.2], color: 0x886611, id: 'lore_narrator_spec' },
    ],
  }),
  ...
  room('SECURITY_CHECKPOINT', {
    ...
    props: [
      ...
      { type: 'frame', position: [0, 0, 2], size: [1.5, 2.5, 0.1], color: 0x777788 },
    ],
  }),
  ...
  room('SERVER_ROOM', {
    ...
    props: [
      ...
      { type: 'monitor', position: [0, 0.9, 0], size: [0.8, 0.5, 0.05], color: 0x111122 },
    ],
  }),
  ...
  room('COOLING_ROOM', {
    ...
    props: [
      ...
      // Cooling control console (interactable)
      { type: 'console', position: [0, 0, 2], size: [1, 0.9, 0.5], color: 0x334455, id: 'cooling_console' },
      // Grated floor
  ...
  room('REACTOR_CORE', {
    ...
    props: [
      ...
      { type: 'monitor', position: [-2.5, 0.9, -2.5], size: [0.6, 0.4, 0.05], color: 0x221100 },
      // Coolant pipes
  ...
  room('DATA_CENTER', {
    ...
    props: [
      ...
      { type: 'monitor', position: [0, 1, 0], size: [1, 0.7, 0.05], color: 0x111122 },
      // Floor cable trays
  ...
  room('DEEP_STORAGE', {
    ...
    props: [
      ...
      { type: 'monitor', position: [0, 0.9, -3], size: [1.2, 0.8, 0.05], color: 0x0a0a0a },
      // Dust/debris
